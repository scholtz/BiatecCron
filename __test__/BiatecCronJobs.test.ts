...
import { BiatecCronJobsClient } from '../contracts/clients/BiatecCronJobsClient';
import * as algokit from '@algorandfoundation/algokit-utils';

const fixture = algorandFixture();
algokit.Config.configure({ populateAppCallResources: true });

let appClient: BiatecCronJobsClient;

describe('BiatecCronJobs', () => {
  ...
  beforeAll(async () => {
    ...
    appClient = new BiatecCronJobsClient(
      {
        sender: testAccount,
        resolveBy: 'id',
        id: 0,
